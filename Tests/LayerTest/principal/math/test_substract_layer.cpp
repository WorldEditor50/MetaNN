...
namespace
{
    ...
    {
        cout << "Test substract layer case 1 ...\t";
        using RootLayer = MakeInferLayer<SubstractLayer>;
    ...
    void test_substract_layer2()
    {
        cout << "Test substract layer case 2 ...\t";

        using RootLayer = MakeTrainLayer<SubstractLayer, CommonInputMap, PFeedbackOutput>;
        static_assert(RootLayer::IsFeedbackOutput, "Test Error");
        static_assert(!RootLayer::IsUpdate, "Test Error");
    ...
    void test_substract_layer3()
    {
        cout << "Test substract layer case 3 ...\t";
        using RootLayer = MakeTrainLayer<SubstractLayer, CommonInputMap, PFeedbackOutput>;
        static_assert(RootLayer::IsFeedbackOutput, "Test Error");
        static_assert(!RootLayer::IsUpdate, "Test Error");
    ...
    void test_substract_layer4()
    {
        ...
        using RootLayer = MakeTrainLayer<SubstractLayer, InputMap, PFeedbackOutput>;
        static_assert(RootLayer::IsFeedbackOutput, "Test Error");
        static_assert(!RootLayer::IsUpdate, "Test Error");
    ...
    void test_substract_layer5()
    {
        ...
        for (size_t i = 0; i < 2; ++i)
        {
            ...
            {
                // Note: since RightOperand should be int, the 3.3f should be translated into 3.
                assert(fabs(res(i, j) - 3 + i1(i, j)) < 0.001);
            }
        }
    ...
    void test_substract_layer6()
    {
        cout << "Test substract layer case 6 (dummy grad input)...\t";
...
namespace Test::Layer::Principal
{
    ...
    {
        test_substract_layer1();
        test_substract_layer2();
        test_substract_layer3();
        test_substract_layer4();
