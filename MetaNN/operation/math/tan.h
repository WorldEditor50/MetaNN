...
{
    using type = OperCalAlgoChain<TailCalculator<OperTan::NSCaseGen::EvalItem, OperTan::NSCaseGen::EvalGroup>>;
};
...
{
    using type = OperCalAlgoChain<TailCalculator<OperTanGrad::NSCaseGen::EvalItem, OperTanGrad::NSCaseGen::EvalGroup>>;
};
